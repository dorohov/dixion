function initMap() {
	...
	var coordMapOfficeOne = {lat: 52.9702561, lng: 36.0821053},
		...
		optionsMapOfficeApteka = {
			zoom: zoomMapOfficeOne,
			center: new google.maps.LatLng(coordMapOfficeApteka.lat, coordMapOfficeApteka.lng),
			//scrollwheel: false,	
			styles: styleMapOfficeOne
		},
		...
		mapOfficeApteka = new google.maps.Map(idOfficeApteka, optionsMapOfficeApteka),
		...
		iconCoordOfficeApteka = {lat: parseFloat(__coord3[0]), lng: parseFloat(__coord3[1])},
		...
		OfficeeApteka = new google.maps.Marker({
			position: iconCoordOfficeApteka,
			map: mapOfficeApteka,
			icon: iconOfficeOne
		});
